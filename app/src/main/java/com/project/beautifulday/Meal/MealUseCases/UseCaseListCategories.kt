...
class UseCaseListCategories@Inject constructor(private val repository: MealRepository) {
    suspend operator fun invoke(): ListMealsState = repository.getListCategories()
}