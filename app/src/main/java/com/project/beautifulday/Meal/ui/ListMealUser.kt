...
@Composable
fun ListMealUser(navController: NavController, viewmodel: MealViewmodel, context: ComponentActivity, viewmodelA: ViewmodelAplication, LgViewModel: LogViewmodel){
        ...
        Box(
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Box(modifier = Modifier.fillMaxSize(),
                    ...
                    Column {
                        ViewCenter(showCenter = 2, navController = navController, viewmodel, LgViewModel = LgViewModel)
                        Box(
                            modifier = Modifier
                                .fillMaxWidth()
