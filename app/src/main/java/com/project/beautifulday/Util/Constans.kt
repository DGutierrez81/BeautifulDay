package com.project.beautifulday.Util

class Constans {

    companion object{
        const val URL_MEAL = "https://www.themealdb.com/api/json/v1/1/"
        const val URL_COCKTAIL = "https://www.thecocktaildb.com/api/json/v1/1/"
